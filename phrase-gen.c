...
static void disp(int sig)
{
	...
	fprintf(stderr,
		"\r%.4llu.%.4llu.%.4llu.%.4llu.%.4llu.%.4llu.%.4llu kilobytes written",
		(counter >> 60) & 1023, (counter >> 50) & 1023,
		(counter >> 40) & 1023, (counter >> 30) & 1023,
		(counter >> 20) & 1023, (counter >> 10) & 1023, counter & 1023);
